...
class LaravelApiClient extends GetxService with ApiClient {
  ...
  LaravelApiClient() {
    ...
    _httpClient = DioClient("https://themistry.in/", new dio.Dio());
  }
  ...
  dynamic getMobilelogin() async {
    Uri _uri = getApiBaseUri("get/otp");
    print("The phone number ${json.encode({
          "phone_number": Get.find<AuthService>()
              .user
              .value
              .phoneNumber
              .toString()
  ...
  void getMobileOTP(String mobileno) async {
    Uri _uri = getApiBaseUri("get/otp");
    print("The phone number ${json.encode({"phone_number": mobileno})}");
    var response = await _httpClient.postUri(
      _uri,
      data: json.encode({"phone_number": mobileno}),
      options: _optionsNetwork,
    );
    if (response.data['status'] == true) {
      // response.data['data']['auth'] = true;
  ...
  Future<User> verifyPhone(String smsCode) async {
    Uri _uri = getApiBaseUri("verify/otp");
    var response = await _httpClient.postUri(
      _uri,
      data: json.encode({
        "phone_number": Get.find<AuthService>()
  ...
  Future<User> verifyOTP(String smsCode, String mobileno) async {
    Uri _uri = getApiBaseUri("verify/otp");
    print("inside laravel provider");
    String data = json.encode({"phone_number": mobileno, "otp": smsCode});
    print("Data:" + data);
    var response = await _httpClient.postUri(
      _uri,
      data: data,
  ...
  Future<User> login(User user) async {
    ...
    print("Params" + json.encode(user.toString()));
    var response = await _httpClient.postUri(
      _uri,
    ...
    if (response.data['success'] == true) {
      response.data['data']['auth'] = true;
      print("Login Response:" + response.data['data'].toString());
      return User.fromJson(response.data['data']);
    } else {
      throw new Exception(response.data['message']);
    }
  ...
  Future<User> updateUser(User user) async {
    ...
    print("Data:" + user.toJson().toString());
    var response = await _httpClient.postUri(
      _uri,
      data: json.encode(user.toJson()),
      options: _optionsNetwork,
  ...
  Future<List<Statistic>> getHomeStatistics() async {
    print("The apitoken is${authService.apiToken}");
    var _queryParameters = {
      'api_token': authService.apiToken,
    };
  ...
  Future<dynamic> registerProvider(RegProvider regProvider) async {
    // var _queryParameters = {
    //   'api_token': authService.apiToken,
    // };5
    Uri _uri =
        getApiBaseUri("provider/full-register/${authService.user.value.id}");
    // Uri _uri = getApiBaseUri(
    // "provider/full-register");
    // .replace(queryParameters: _queryParameters);
    regProvider.providerId = authService.user.value.id;
    print("${_uri} ${regProvider.toJson()}");
    print("Request:" + json.encode(regProvider.toJson()));
    var response = await _httpClient.postUri(
      _uri,
      data: json.encode(regProvider.toJson()),
      options: _optionsNetwork,
    );
  ...
  Future<List<EService>> getEService(String id) async {
    var _queryParameters = {
    ...
    Uri _uri = getApiBaseUri("services/$id")
        .replace(queryParameters: _queryParameters);
  ...
  Future<List<EService>> getEProviderEServices(
    ...
    print("Params:" + _queryParameters.toString());
    Uri _uri = getApiBaseUri("provider/e_services")
        .replace(queryParameters: _queryParameters);
  ...
  Future<List<CatService>> getServiceCategories() async {
    ...
    if (response.data['success'].toString() == "true") {
      ...
      return [];
      // return response.data['data']
      //     .map<CatService>((obj) => CatService.fromJson(obj))
      //     .toList();
    } else {
      throw new Exception(response.data['message']);
    }
  ...
  Future<List<CatService>> getService(String id) async {
    var _queryParameters = {
      'api_token': authService.apiToken,
    };
    Uri _uri = getApiBaseUri("services/${id}")
  ...
  Future<List<EProviderType>> getProvidertype() async {
    ...
    //   'api_token': authService.apiToken,
    // };
    Uri _uri = getApiBaseUri("e_provider_types");
    var response = await _httpClient.getUri(_uri, options: _optionsNetwork);
    if (response.data['success'] == true) {
      return response.data['data']
          .map<EProviderType>((obj) => EProviderType.fromJson(obj))
  ...
  Future<List<States>> getState() async {
    ...
    //   'api_token': authService.apiToken,
    // };
    Uri _uri = getApiBaseUri("states");
    var response = await _httpClient.getUri(_uri, options: _optionsNetwork);
    if (response.data['success'].toString() == "true") {
      return response.data['data']
          .map<States>((obj) => States.fromJson(obj))
          .toList();
    } else {
      throw new Exception(response.data['message']);
    }
  ...
  Future<List<Places>> getCities(String id) async {
    ...
    //   'api_token': authService.apiToken,
    // };
    Uri _uri = getApiBaseUri("cities/${id}");
    var response = await _httpClient.getUri(_uri, options: _optionsNetwork);
    if (response.data['success'].toString() == "true") {
      return response.data['data']
          .map<Places>((obj) => Places.fromJson(obj))
          .toList();
    } else {
      throw new Exception(response.data['message']);
    }
