...
class DioClient {
  ...
  DioClient(
    ...
    if (!kIsWeb && !kDebugMode) {
      optionsCache = buildCacheOptions(Duration(days: 3),
          forceRefresh: true, options: optionsCache);
      optionsNetwork = buildCacheOptions(Duration(minutes: 10),
          forceRefresh: false, options: optionsNetwork);
      _dio.interceptors
