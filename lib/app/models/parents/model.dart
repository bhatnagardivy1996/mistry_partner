...
abstract class Model {
  ...
  Media avatarFromJson(Map<String, dynamic> json, String attribute) {
    try {
      Media media = new Media(
          id: json[attribute]['id'].toString(),
          type: 'avatar',
          url: json[attribute]['url'],
          thumb: json[attribute]['thumb'],
          icon: json[attribute]['icon']);
      return media;
    } catch (e) {
      throw Exception(
          'Error while parsing ' + attribute + '[' + e.toString() + ']');
