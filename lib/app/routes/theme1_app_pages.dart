...
import '../modules/auth/views/Provider_form.dart';
import '../modules/auth/views/forgot_password_view.dart';
import '../modules/auth/views/language_choose.dart';
...
class Theme1AppPages {
  static final INITIAL =
      Get.find<AuthService>().user.value.isProvider ? Routes.ROOT : Routes.LANG;
  ...
  static final routes = [
    ...
    GetPage(
        ...
        binding: AuthBinding()),
    GetPage(
        name: Routes.PROVIDER_REGISTRATION,
        page: () => ProviderFormView(),
        binding: AuthBinding()),
    GetPage(
